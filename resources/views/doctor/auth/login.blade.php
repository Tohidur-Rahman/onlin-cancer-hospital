...
<body class="hold-transition theme-primary bg-img" style="background-image: url({{asset('contents/admin')}}/images/auth-bg/slide-4.jpg)">
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								<h2 class="text-primary">Doctor Login Panel</h2>
								...
								<form method="POST" action="{{ route('doctor.login') }}">
									...
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="email" class="form-control ps-15 bg-transparent" placeholder="Email" name="email" :value="old('email')" required autofocus>
										</div>
									</div>
									<div class="form-group">
										<div class="input-group mb-3">
