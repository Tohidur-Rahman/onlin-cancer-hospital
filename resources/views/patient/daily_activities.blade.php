    ...
    <div class="col-xxxl-12 col-xl-12 col-12">
      <div class="mb-20 d-flex justify-content-between align-items-center">
        <h1 class="my-md-0 mb-10">Daily Activities</h1>
          ...
          <a href="{{ route('patient.edit_activities',$patient_activities->id) }}">
            <button type="button" class="waves-effect waves-light btn btn-primary"><i class="mdi mdi-plus me-15"></i>Edit Record</button>
          </a>
          @else
          <a href="{{ route('patient.activities') }}">
      ...
      <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4">
          <div class="box">
            <div class="box-body">
              <div class="mb-15 d-flex justify-content-between align-items-center">
                <h4 class="my-0">Blood Pressure</h4>
