          ...
          <a href="#" class="waves-effect waves-light dropdown-toggle w-auto l-h-12 bg-transparent p-0 no-shadow"
            ...
            <div class="d-flex pt-1">
              <div class="text-end me-10">
                <p class="pt-5 fs-14 mb-0 fw-700 text-primary">{{ Auth::guard('patient')->user()->first_name }} {{ Auth::guard('patient')->user()->last_name }}</p>
                <small class="fs-10 mb-0 text-uppercase text-mute">Patient</small>
              </div>
              <img src="{{asset('uploads/patient/'. Auth::guard('patient')->user()->image)}}" class="avatar rounded-10 bg-lightgreen h-40 w-40" alt="" />
            </div>
          </a>
