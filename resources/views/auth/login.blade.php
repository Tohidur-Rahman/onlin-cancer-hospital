...
<body class="hold-transition theme-primary bg-img"
    style="background-image: url({{asset('contents/admin')}}/images/auth-bg/bg-1.jpg)">
                    ...
                    <div class="col-lg-5 col-md-5 col-12">
                        <div class="bg-white rounded10 shadow-lg">
                            <div class="content-top-agile p-20 pb-0">
                                <h2 class="text-primary">Admin Login Panel</h2>
                                <p class="mb-0">Log in to continue to admin panel.</p>
                            </div>
                            <div class="p-40">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control ps-15 bg-transparent"
